...
from attn_ctrl.lefusion import LatentEventFusion
from attn_ctrl.lfnet import LatentFedNet
...
class EVSFrameInterpolationWithNoiseInjectionPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        self.enhance = LatentFedNet(in_channels=4, out_channels=4)
    ...
    def __call__(
        ...
        enhance_model = self.enhance
        enhance_model.to(latents.device).to(latents.dtype)
        latents = enhance_model(latents)
